...
Head to the [Quick Start](./getting-started.md) to set up your own vault in about 10 minutes.

Browse [Recipes](./recipes/index.md) for guides on specific capabilities like email integration, birthday reminders, and more.
